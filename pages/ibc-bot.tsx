  ...
  const [state, setState] = useReducer(
    ...
    }),
    {
      ...
      currentCollection: {
        ...
        disabled: false,
        contract: props.collections[0].contract,
      },
    }
  );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="IBC Bot is a Discord bot for community management, including NFT proof-of-ownership that allows you to verify NFT holders and tokenize your community."
        />
      </Head>
      <Menu />
      <main className={styles.main}>
        ...
        <div
          className={classNames(
            state.alertMsg !== ""
              ? "absolute bottom-5 right-1 lg:right-5"
              : "hidden"
          )}
        >
          <Alert
        ...
        collections: [
          {
            ...
            disabled: true,
            contract: { address: null, hash: null },
          },
        ],
