...
const exploreDropdownItems = [
  {
    title: "All",
    link: "https://www.ibcnfts.com/ibc-nfts-explore",
    disabled: false,
  },
  {
    title: "AssetMantle 🪐",
    link: "https://www.ibcnfts.com/ibc-networks/assetmantle",
    disabled: false,
  },
  {
    title: "Evmos ☄️",
    link: "https://www.ibcnfts.com/ibc-networks/evmos",
    disabled: false,
  },
  {
    title: "Cosmos Network ⚛️",
    link: "https://www.ibcnfts.com/ibc-networks/cosmos-network",
    disabled: false,
  },
  {
    title: "OmniFlix 🖍️",
    link: "https://www.ibcnfts.com/ibc-networks/omniflix-network",
    disabled: false,
  },
  {
    title: "Secret Network 🤫",
    link: "https://www.ibcnfts.com/ibc-networks/secret-network",
    disabled: false,
  },
  {
    title: "Stargaze ⭐",
    link: "https://www.ibcnfts.com/ibc-networks/stargaze",
    disabled: false,
  },
  {
    title: "Terra 🌎",
    link: "https://www.ibcnfts.com/ibc-networks/terra",
    disabled: false,
  },
];
...
const menuItems = [
  ...
  {
    title: "Drops 🎁",
    link: "https://www.ibcnfts.com/nft-raffles-crypto-giveaways-stakedrops",
  },
  { title: "Apply 📄", link: "https://patrik768772.typeform.com/IBCNFTs" },
  {
    title: "DM 💬",
    link: "https://twitter.com/messages/compose?recipient_id=1482410071535591427",
  },
];
...
const Menu: FunctionComponent = () => {
  return (
    <Disclosure
      as="nav"
      className="bg-white shadow-[1px_1px_13px_0_rgb(0,0,0,0.3)] relative"
    >
      {({ open }) => (
        <>
          <Image
            className="sm:hidden flex"
            src="/assetmantle_mobile_banner.png"
            width={2400}
            height={360}
            alt="banner"
          />
          <Image
            ...
            src="/assetmantle_desktop_banner.png"
            width={2400}
            height={120}
            alt="banner"
          />
                    ...
                    {menuItems.map((item) => {
                      return (
                        <Link
                          ...
                          legacyBehavior={true}
                        >
                          <a className="whitespace-nowrap text-[#1d1d1d] hover:text-lightgreen inline-flex items-center px-1 pt-1 text-md font-normal">
                            {item.title}
                          </a>
                        </Link>
                      );
          ...
          <Disclosure.Panel className="lg:hidden">
            <div className="pt-2" style={{ borderTop: "1px solid #000" }}>
              ...
              {menuItems.map((item) => {
                return (
                  <div
                    className="py-5 hover:cursor-pointer group menu-item"
                    key={item.title}
                  >
                    <a
                      href={item.link}
