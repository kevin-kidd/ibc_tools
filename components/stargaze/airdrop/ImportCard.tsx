        ...
        <div className="main-card">
            ...
            <div className="grid xl:grid-cols-4 mb-4 ml-10 mt-10">
                <ul className="col-span-3 list-disc">
                    <li>
                        Fill out one of our{" "}
                        <a target="_blank" rel="noreferrer" className="hover:text-[#85ff89] text-black transition duration-150 font-bold" href="https://kevin-k.gitbook.io/ibc-nfts-tools/guides/airdrop-nfts-on-stargaze#import-your-airdrop-list">
                            airdrop templates
                        </a>.
                    </li>
