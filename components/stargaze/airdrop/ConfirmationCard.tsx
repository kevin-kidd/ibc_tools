...
const ConfirmationCard: FunctionComponent<StateProps> = ({ state, setState }) => {
        return (
            <div className="mx-auto main-card w-full pt-10 px-4">
                ...
                <div className="flex justify-center mt-2">
                    ...
                    tokens to
                    ${state.uniqueAmount === undefined ? "?" : state.uniqueAmount.toString()}
                    unique addresses.`}</p>
                </div>
                ...
                <div className="inline-flex flex justify-center w-full gap-x-6 mt-4">
                    <button
                        ...
                        className="py-2 px-4 bg-[#85ff89] text-[#1D1D1D] border-[#1d1d1d] border transition duration-200 focus:outline-none button-dropshadow"
                    >
                        Yes
                    </button>
                    <button
